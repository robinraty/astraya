  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 border-t border-astraya-border bg-astraya-background/95 px-6 py-3 text-astraya-muted backdrop-blur">
      <div className="mx-auto flex w-full max-w-md items-center justify-around">
        <button
          type="button"
          className="flex flex-col items-center gap-1 transition hover:text-astraya-text"
        >
        ...
        <button
          type="button"
          className="flex flex-col items-center gap-1 text-astraya-accent transition hover:text-astraya-text"
        >
          <span className="text-lg">＋</span>
